                ...
                <article class="post-container">
                    <div class="post-thumb">
                        <a href="#" class="d-block position-relative overflow-hidden">
                            <img src="books\Music\1.jpg" class="img-fluid" alt="Blog Post">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="entry-header">
                            <h3><a href="blog-post.html">The Book of Musical Knowledge</a></h3>
                        </div>
                        <a href="books\Music\TheBookofMusicalKnowledge.pdf" target="_blank" class="btn btn-pdf">View</a> <a href="books\Music\TheBookofMusicalKnowledge.pdf" download="TheBookofMusicalKnowledge.pdf" class="btn btn-download">Download</a>
                    </div>
                </article>
            </div>
            <!-- Article Ends -->
