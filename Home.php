    ...
    <div class="row home-details-container align-items-center">
        ...
        <div class="col-12 col-lg-8 offset-lg-4 home-details text-left text-sm-center text-lg-left">
            <div>
                ...
                <h1 class="text-uppercase poppins-font"><span>ONLINE</span> E-LIBRARY </h1>
                <p class="open-sans-font">Books are important for the mind, heart, and soul.</p>
                <a href="login.php" class="btn btn-about">LOGIN</a> 
            </div>
        </div>
    </div>
</section>
